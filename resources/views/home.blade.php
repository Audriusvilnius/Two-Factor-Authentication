                            ...
                            <div class="card m-1 " style="width: 18rem;">
                                <div class="card-body">
                                    @if ($item->movement == 1)
                                        ...
                                        <h5 class="card-title">Movement sensor actyvate</h5>
                                        <p class="card-text">Some quick example text to build on the card title and make up
                                            the bulk of the card's content.</p>
                                    @else
                                        <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56"
                                        ...
                                        <h5 class="card-title">Movement sensor deactyvate</h5>
                                        <p class="card-text">Some quick example text to build on the card title and make up
                                            the bulk of the card's content.</p>
                                    @endif
                                </div>
                            ...
                            <div class="card m-1 " style="width: 18rem;">
                                <div class="card-body">
                                    @if ($item->glass_break == 1)
                                        ...
                                        <h5 class="card-title">Glass break sensor actyvate</h5>
                                        <p class="card-text">Some quick example text to build on the card title and make up
                                            the bulk of the card's content.</p>
                                    @else
                                        <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56"
                                        ...
                                        <h5 class="card-title">Glass break sensor deactyvate</h5>
                                        <p class="card-text">Some quick example text to build on the card title and make up
                                            the bulk of the card's content.</p>
                                    @endif
                                </div>
                            ...
                            <div class="card m-1 " style="width: 18rem;">
                                <div class="card-body">
                                    @if ($item->perimeter == 1)
                                        ...
                                        <h5 class="card-title">Perimeter securiyt actyvate</h5>
                                        <p class="card-text">Some quick example text to build on the card title and make up
                                            the bulk of the card's content.</p>
                                        <a href="#" class="btn btn-primary">Disarm</a>
                                    @else
                                        ...
                                        <h5 class="card-title">Perimeter securiyt deactyvate</h5>
                            ...
                            <div class="card m-1 " style="width: 18rem;">
                                <div class="card-body">
                                    @if ($item->smoke == 1)
                                        ...
                                        <h5 class="card-title">Smoke sensor actyvate</h5>
                                        <p class="card-text">Some quick example text to build on the card title and make up
                                            the bulk of the card's content.</p>
                                    @else
                                        <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56"
                                        ...
                                        <h5 class="card-title">Smoke sensor deactyvate</h5>
                                        <p class="card-text">Some quick example text to build on the card title and
                                            make
                                            up
                                            the bulk of the card's content.</p>
